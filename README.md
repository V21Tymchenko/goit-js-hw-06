...
все <li> за одну операцию в список ul#ingredients. Задание 3​
...
счтетчика. Обновляй интерфейс новым значением переменной counterValue. Задание 5​
...
данными в консоль и очисти значения полей формы методом reset. Задание 9​
